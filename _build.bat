em++^
 src/c_code/main.cpp src/c_code/src/renderer.cpp src/c_code/src/shaders/BaseShader.cpp src/c_code/src/material/Material.cpp src/c_code/src/material/ColorMaterial.cpp^
 ...
 src/c_code/src/camera/PerspectiveCamera.cpp src/c_code/src/mesh/Mesh.cpp src/c_code/src/mesh/QuadMesh.cpp src/c_code/src/scene/Scene.cpp^
 src/c_code/src/scene/SceneManager.cpp^
